    ...
    while not S.isEmpty():
        ...
        if state not in discovered:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                ...
                #print(successor)
                #print(actions)
                    S.push((successor, directions + [action]))
        ...
        if state not in discovered:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                if successor not in discovered:
                    #print(successor)
                    #print(actions)
                    Queue.push((successor, directions + [action]))
        ...
        if state not in discovered:
            ...
            for successor, action, stepCost in problem.getSuccessors(state):
                if successor not in discovered:
                    ...
                    #print(actions)
                    getCost = stepCost + problem.getCostOfActions(directions)
                    getHeuristic = heuristic(successor, problem)
                    pQueue.push((successor, directions + [action]), getCost + getHeuristic)
# Abbreviations
